...
deseq_df <- rbind(return_dataframe(deseq_res_P1), return_dataframe(deseq_res_P2), return_dataframe(deseq_res_P3), return_dataframe(deseq_res_time))
...
zig_df <- rbind(return_dataframe_zig(zig_res_P1), return_dataframe_zig(zig_res_P2), return_dataframe_zig(zig_res_P3), return_dataframe_zig(zig_res_time))
...
ancom_df <- rbind(return_dataframe_ancom(ancom_res_P1$out), return_dataframe_ancom(ancom_res_P2$out),
                  return_dataframe_ancom(ancom_res_P3$out), return_dataframe_ancom(ancom_res_time$out)) #ignore warning
keep <- apply(ancom_df, 1, function(x) return(!all(is.na(x))))
