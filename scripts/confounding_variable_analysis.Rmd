...
#Skip first element because its weird
for(var in permanova_res$Variable[2:nrow(permanova_res)]){
  print(var)
  tmp <- run_metagenom_seq(ps_no_norm_filt, variable = as.character(var), 30, .05)
