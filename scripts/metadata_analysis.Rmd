...
sample_timepoint_dependent_factors <- c("GI.symptoms.within.3.months..M3.", "GI.issues.this.week..M3.", "Stool.sample.collection.method..M3.", "Problems.collecting.stool.sample..M3.", "Recently.ill" , "Season" , "Fever", "Travel.to.country", "Other.symptoms.this.week..M3.", "Small.pet.rodent")
