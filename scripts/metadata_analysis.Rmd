...
sample_timepoint_dependent_factors <- c("GI.symptoms.within.3.months..M3.", "GI.issues.this.week..M3.", "GI.issues.one.month.ago..M3.", "GI.issues.two.months.ago..M3.", "GI.issues.three.months.ago..M3.", "Stool.sample.collection.method..M3.", "Problems.collecting.stool.sample..M3.", "Recently.ill", "Recent.anxiety..caretaker.reported." , "Season" , "Fever", "Travel.to.country", "Other.symptoms.this.week..M3.", "Small.pet.rodent")
...
# p-value correction
chisquare_p.val<-p.adjust(chisquare_p.val)
sig_catvar2 <-chisquare_p.val[chisquare_p.val < 0.05]
...
num_cat_timepoint_dependent <- c(dict_1_items, "Length.of.recent.foreign.travel")
