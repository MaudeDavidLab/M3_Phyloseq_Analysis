...
col_1<-c("Pet.dog","Pet.cat", "Minimum.time.since.antibiotics",
                  ...
                  "Racial.group","Specific.food.allergy","GI.issues.this.week" ,
                  "Other.GI.symptoms","Biological.sex",
                  ...
                  "Seafood..consumption","Sweetened.drink..consumption",
                  "Vegetable..consumption","Restaurant.prepared.meals.consumption",
                  "Sugary.food.consumption")
 col_2<-c("Diet.during.infancy","Lactose.intolerance","Age..months.",
                  "Multivitamin","Born.prematurely","Probiotic..consumption",
                  "Dietary.restrictions","Environmental.tobacco.smoke.exposure",
                  "Dietary.supplement","Vitamin.B.complex.supplement.consumption",
