...
#subject to change
setwd("~/Tree_M3_datasets/M3_Phyloseq_Analysis_breastfedout/")

#Deseq results
ps_no_norm_filt <- readRDS("results/Filtered/ps_no_norm_friedfilt.rds")
deseq_res_P1 <- readRDS("results/DESeq/deseq_res_P1_adjp0.05.rds")
deseq_res_P2 <- readRDS("results/DESeq/deseq_res_P2_adjp0.05.rds")
deseq_res_P3 <- readRDS("results/DESeq/deseq_res_P3_adjp0.05.rds")

deseq_res_time <- readRDS("results/DESeq/Deseq_time_interaction_adjp0.05.rds")
...
zig_res_P1 <- readRDS("results/metagenomseq/zig_res_P1_adjp0.05.rds")
zig_res_P2 <- readRDS("results/metagenomseq/zig_res_P2_adjp0.05.rds")
zig_res_P3 <- readRDS("results/metagenomseq/zig_res_P3_adjp0.05.rds")

zig_res_time <- readRDS("results/metagenomseq/zig_res_time_adjp0.05.rds")
...
fullsigtab_esv$Genus[which(fullsigtab_esv$Enrichment == "ControlAut")]
...
ancom_time<-readRDS("results/ANCOM/ancom_res0.05.rds")
ancom1<-readRDS("results/ANCOM/ancom_res1_0.05.rds")
ancom2<-readRDS("results/ANCOM/ancom_res2_0.05.rds")
ancom3<-readRDS("results/ANCOM/ancom_res3_0.05.rds")
...
ps <- readRDS("results/Normalized/ps_tss_pass_min_postDD_min0.03.rds")
...
write.csv(fullsigtab_esv, file = "EnrichmentASV_Table_with_ANCOM_breastfed_2020.csv")
