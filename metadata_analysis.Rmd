...
#combining for full list of variable differences

all_different_variabbles<-c(num_confounds_all, names(all_chisquare))
saveRDS(all_different_variabbles, "var_diff_btwn_cohorts.rds")
