...
heatmap <- ps_DeSeq_norm_pass_min_postDD_sup003@otu_table[full_sigtab_esv_confoundfiltered_consist$ASV,]
heatlabel <-gsub("g__","",full_sigtab_esv_confoundfiltered_consist$Genus)
for (x in 1:11){
  if (heatlabel[x] == "unclassified"){
    heatlabel[x]<-paste(gsub("c__", "", full_sigtab_esv_confoundfiltered_consist$Class[x]), heatlabel[x], sep = "_")
  }
  heatlabel[x] <- paste(heatlabel[x], x, sep = ".")
}
