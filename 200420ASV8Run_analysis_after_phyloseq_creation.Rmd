...
print(make_vis_plots_print(ps_TSS_norm_pass_min_postDD_sup003, 'phenotype', full_sigtab_esv_confoundfiltered$ASV[20], 'bar', full_sigtab_esv_confoundfiltered$Classp[20]))
...
print(make_vis_plots_print(ps_TSS_norm_pass_min_postDD_sup003, 'phenotype', full_sigtab_esv_confoundfiltered$ASV[18], 'bar', full_sigtab_esv_confoundfiltered$Genusp[18]))
...
print(make_vis_plots_print(ps_TSS_norm_pass_min_postDD_sup003, 'phenotype', full_sigtab_esv_confoundfiltered$ASV[15], 'bar', full_sigtab_esv_confoundfiltered$Classp[15]))

print(make_vis_plots_print(ps_TSS_norm_pass_min_postDD_sup003, 'phenotype', full_sigtab_esv_confoundfiltered$ASV[13], 'bar', full_sigtab_esv_confoundfiltered$Genusp[13]))

print(make_vis_plots_print(ps_TSS_norm_pass_min_postDD_sup003, 'phenotype', full_sigtab_esv_confoundfiltered$ASV[10], 'bar', full_sigtab_esv_confoundfiltered$Classp[10]))

print(make_vis_plots_print(ps_TSS_norm_pass_min_postDD_sup003, 'phenotype', full_sigtab_esv_confoundfiltered$ASV[5], 'bar', full_sigtab_esv_confoundfiltered$Genusp[5]))

print(make_vis_plots_print(ps_TSS_norm_pass_min_postDD_sup003, 'phenotype', full_sigtab_esv_confoundfiltered$ASV[3], 'bar', full_sigtab_esv_confoundfiltered$Genusp[3]))
...
full_sigtab_esv_confoundfiltered_consist <- full_sigtab_esv_confoundfiltered[c(1,3,4,10,13,15,17,18,19,20,14),]
