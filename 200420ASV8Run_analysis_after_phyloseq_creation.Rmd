...
### Biological.sex, Chi-square, wilcoxon/t-test
...
chisquare_p.val<-chisquare_p.val[-which(names(chisquare_p.val) %in% c("LR5.prediction..M3.", "LR6.prediction..M3.", "LR10.prediction..M3."))]

length(chisquare_p.val) #18
...
num_confounds_all <- num_confounds_all[-which(num_confounds_all %in% c("LR6.probability.not.ASD..M3.", "LR6.probability.ASD..M3.", "LR10.probability.not.ASD..M3.", "LR10.probability.ASD..M3.", "LR5.probability.not.ASD..M3.", "LR5.probability.ASD..M3." ))]
...
ps_DeSeq_norm_pass_min_postDD_sup003_full <- ps_DeSeq_norm_pass_min_postDD_sup003
...
saveRDS(impacting_compo, file = "impacting_var")
...
print(make_vis_plots_print(ps_TSS_norm_pass_min_postDD_sup003, 'phenotype', full_sigtab_esv_confoundfiltered$ASV[6], 'bar', full_sigtab_esv_confoundfiltered$Genusp[6]))
...
#note - maybe blast ASV7? not even classified at phylum lvl
...
print(make_vis_plots_print(ps_TSS_norm_pass_min_postDD_sup003, 'phenotype', full_sigtab_esv_confoundfiltered$ASV[11], 'bar', full_sigtab_esv_confoundfiltered$Genusp[11]))

print(make_vis_plots_print(ps_TSS_norm_pass_min_postDD_sup003, 'phenotype', full_sigtab_esv_confoundfiltered$ASV[12], 'bar', full_sigtab_esv_confoundfiltered$Genusp[12]))

print(make_vis_plots_print(ps_TSS_norm_pass_min_postDD_sup003, 'phenotype', full_sigtab_esv_confoundfiltered$ASV[14], 'bar', full_sigtab_esv_confoundfiltered$Genusp[14]))

print(make_vis_plots_print(ps_TSS_norm_pass_min_postDD_sup003, 'phenotype', full_sigtab_esv_confoundfiltered$ASV[15], 'bar', full_sigtab_esv_confoundfiltered$Genusp[15]))

print(make_vis_plots_print(ps_TSS_norm_pass_min_postDD_sup003, 'phenotype', full_sigtab_esv_confoundfiltered$ASV[17], 'bar', full_sigtab_esv_confoundfiltered$Genusp[17]))

print(make_vis_plots_print(ps_TSS_norm_pass_min_postDD_sup003, 'phenotype', full_sigtab_esv_confoundfiltered$ASV[19], 'bar', full_sigtab_esv_confoundfiltered$Genusp[19]))

print(make_vis_plots_print(ps_TSS_norm_pass_min_postDD_sup003, 'phenotype', full_sigtab_esv_confoundfiltered$ASV[20], 'bar', full_sigtab_esv_confoundfiltered$Genusp[20]))

print(make_vis_plots_print(ps_TSS_norm_pass_min_postDD_sup003, 'phenotype', full_sigtab_esv_confoundfiltered$ASV[21], 'bar', full_sigtab_esv_confoundfiltered$Genusp[21]))

print(make_vis_plots_print(ps_TSS_norm_pass_min_postDD_sup003, 'phenotype', full_sigtab_esv_confoundfiltered$ASV[22], 'bar', full_sigtab_esv_confoundfiltered$Genusp[22]))

print(make_vis_plots_print(ps_TSS_norm_pass_min_postDD_sup003, 'phenotype', full_sigtab_esv_confoundfiltered$ASV[23], 'bar', full_sigtab_esv_confoundfiltered$Genusp[23]))

print(make_vis_plots_print(ps_TSS_norm_pass_min_postDD_sup003, 'phenotype', full_sigtab_esv_confoundfiltered$ASV[24], 'bar', full_sigtab_esv_confoundfiltered$Genusp[24]))

print(make_vis_plots_print(ps_TSS_norm_pass_min_postDD_sup003, 'phenotype', full_sigtab_esv_confoundfiltered$ASV[25], 'bar', full_sigtab_esv_confoundfiltered$Genusp[25]))

print(make_vis_plots_print(ps_TSS_norm_pass_min_postDD_sup003, 'phenotype', full_sigtab_esv_confoundfiltered$ASV[29], 'bar', full_sigtab_esv_confoundfiltered$Genusp[29]))

for (i in 1:29){
print(make_vis_plots_print(ps_TSS_norm_pass_min_postDD_sup003, 'phenotype', full_sigtab_esv_confoundfiltered$ASV[i], 'bar', full_sigtab_esv_confoundfiltered$Genusp[i]))
}
enriched_in_time<-c("N_1","A_1","A_1","A_2","A_2","A_2","A_2","A_3","N_3","N_3","A_3","N_3","A_3","A_3","A_all","A_all","A_all","A_all","A_all","A_1all","A_3all","N_3all","A_3all","A_1","N_1","A_1","A_3","N_3","N_13")

enriched_in <- gsub("_", "", enriched_in_time)
enriched_in <- gsub("1", "", enriched_in)
enriched_in <- gsub("2", "", enriched_in)
enriched_in <- gsub("3", "", enriched_in)
enriched_in <- gsub("all", "", enriched_in)

table_print <- tibble(full_sigtab_esv_confoundfiltered$ASV, full_sigtab_esv_confoundfiltered$Classp, full_sigtab_esv_confoundfiltered$Family, full_sigtab_esv_confoundfiltered$Genusp, enriched_in)
colnames(table_print) <- c("ASV", "Class","Family" ,"Genus", "Cohort Enrichment")
write.csv(table_print, "29_ASV_by_Genus_and_Enrichment.csv")

full_sigtab_esv_confoundfiltered_consist <- full_sigtab_esv_confoundfiltered[c(1,6,7,8,11,12,14,15,17,19,20,21,22,23,24,25,29),]
...
#For 29 (set of asvs with confounds filtered out)
ROC.perf_29 <-rand_forest(pred_sequences = rownames(full_sigtab_esv_confoundfiltered), ps = ps_DeSeq_norm_pass_min_postDD_sup003)

#For 70 (unfiltered results)
ROC.perf_70 <-rand_forest(rownames(fullsigtab_esv), ps_DeSeq_norm_pass_min_postDD_sup003)

#For 17 (ASVs from the 24 who are consistantly enriched/depleted over timepoints)
#ROC.perf_17_all <-rand_forest(pred_sequences = full_sigtab_esv_confoundfiltered_consist$ASV, ps = ps_DeSeq_norm_pass_min_postDD_sup003)



#Combine AUCs
AUC_all <- c(ROC.perf_29[1], ROC.perf_70[1])#, ROC.perf_17_all[1])

#Plot
{plot(ROC.perf_29[[2]], main = "10-Cross Validation for ASD Classification", col = rainbow(8)[1])
plot(ROC.perf_70[[2]], main = "10-cross validation", col = rainbow(8)[2], add = TRUE)
#plot(ROC.perf_17_all[[2]], main = "10-cross validation", col = rainbow(8)[3], add = TRUE)
lines(c(0,1), c(0,1), col = "black")
legend(title = "AUC value", .81, .33, legend=round(as.numeric(AUC_all), digits = 4),
       col=colors,cex=1.0)

predictors_name <- c("29 Diff. Abundant ASVs", "70 Diff. Abundant ASVs")#, "Selected 17 ASVs")
...
ROC.perf_29_P1 <-rand_forest(pred_sequences = rownames(full_sigtab_esv_confoundfiltered), ps = P1_des)
ROC.perf_29_P2 <-rand_forest(pred_sequences = rownames(full_sigtab_esv_confoundfiltered), ps = P2_des)
ROC.perf_29_P3 <-rand_forest(pred_sequences = rownames(full_sigtab_esv_confoundfiltered), ps = P3_des)
AUC_all <- c(ROC.perf_29_P1[1], ROC.perf_29_P2[1], ROC.perf_29_P3[1])


{plot(ROC.perf_29_P1[[2]], main = "10-cross validation for 24 Sequences by Timepoint", col = rainbow(8)[1])
plot(ROC.perf_29_P2[[2]], main = "10-cross validation", col = rainbow(8)[2], add = TRUE)
plot(ROC.perf_29_P2[[2]], main = "10-cross validation", col = rainbow(8)[3], add = TRUE)
lines(c(0,1), c(0,1), col = "black")
legend(title = "AUC value", .853, .33, legend=round(as.numeric(AUC_all), digits = 4),
       col=colors,cex=1.0)

predictors_name <- c("29 Diff. Abundant ASVs P1", "29 Diff. Abundant ASVs P2","29 Diff. Abundant ASVs P3")
legend(title = "Predictors",.375, .33, legend=predictors_name,
       col=c(rainbow(8)[c(1,2,3,5,7,6,8)], hcl.colors(1, palette = "viridis")),cex=1.0, lty=1:7)
}
