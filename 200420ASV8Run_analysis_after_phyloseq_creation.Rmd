...
meta_cat<-as.data.frame(rep("FALSE", length(colnames(sample_data(ps_not_norm_comp)))), row.names = colnames(sample_data(ps_not_norm_comp)))
colnames(meta_cat) <- c("diet")
levels(meta_cat$diet) <- c("FALSE", "TRUE")
meta_cat$diet[c(49, 50, 59:76, 78, 81, 86, 87, 90, 91, 133:139, 144, 154, 160, 165:172, 169, 184, 189, 194, 201:204, 206, 208, 213, 215:217, 223, 224, 225, 228:232, 255, 269, 271, 273, 285:290, 294, 301:305, 309, 312:321, 326, 332, 349, 351, 352, 356, 357, 360)] <- rep("TRUE", length(meta_cat$diet[c(49, 50, 59:76, 78, 81, 86, 87, 90, 91, 133:139, 144, 154, 160, 165:172, 169, 184, 189, 194, 201:204, 206, 208, 213, 215:217, 223, 224, 225, 228:232, 255, 269, 271, 273, 285:290, 294, 301:305, 309, 312:321, 326, 332, 349, 351, 352, 356, 357, 360)]))

# list of diet questions
diet_info<-metadata_ok[,which(meta_cat$diet==TRUE)]
