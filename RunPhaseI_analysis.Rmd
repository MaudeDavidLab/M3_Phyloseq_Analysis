...
M3folder_loc='/Users/shokoiwai/Google Drive/M3/'
# M3 repo location
...
for(i in 1:nrow(DDreslist)){
  ...
  # read taxonomy table
  tax_data=fread(paste0(M3folder_loc, as.character(DDreslist[i, V2]), '700_greengenes_strains_taxtable.csv'), header=TRUE)
  setnames(tax_data, 'OTU', 'ASV')
  # read abundance table
  dd_data=fread(paste0(M3folder_loc, as.character(DDreslist[i, V2]), '400_DADA_ASVabundance_withSequence.csv'), header=TRUE)
