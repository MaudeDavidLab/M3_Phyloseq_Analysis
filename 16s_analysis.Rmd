...
ps_no_norm_filt <- readRDS("Filtered/ps_no_norm_friedfilt.rds")
```
...
deseq_res_P1[[2]]$log2FoldChange
rownames(deseq_res_P1[[2]])[1]
...
saveRDS(zig_res_P1, file=paste0("metagenomseq/zig_res_P1_adjp", mtgseq_cut, ".rds"))
saveRDS(zig_res_P2, file=paste0("metagenomseq/zig_res_P2_adjp", mtgseq_cut, ".rds"))
saveRDS(zig_res_P3, file=paste0("metagenomseq/zig_res_P3_adjp", mtgseq_cut, ".rds"))
saveRDS(zig_res_time, file=paste0("metagenomseq/zig_res_time_adjp", mtgseq_cut, ".rds"))
...
```{r}
deseq_res_P1 <- readRDS("DESeq/deseq_res_P1_adjp0.05.rds")
deseq_res_P2 <- readRDS("DESeq/deseq_res_P2_adjp0.05.rds")
deseq_res_P3 <- readRDS("DESeq/deseq_res_P2_adjp0.05.rds")
deseq_res_time <- readRDS("DESeq/Deseq_time_interaction_adjp0.05.rds")

zig_res_P1 <- readRDS("metagenomSeq/zig_res_P1_adjp0.05.rds")
zig_res_P2 <- readRDS("metagenomSeq/zig_res_P2_adjp0.05.rds")
zig_res_P3 <- readRDS("metagenomSeq/zig_res_P3_adjp0.05.rds")
zig_res_time <- readRDS("metagenomSeq/zig_res_time_adjp0.05.rds")
...
ps_tss <- readRDS("Normalized/ps_tss_pass_min_postDD_min0.03.rds")
```
...
significant_tax <- merge(data.table(deseq_res_P1[[2]], keep.rownames=TRUE)[, list(rn, deseq_P1_adjp=padj, enrichment1des=enrichment)],
                         data.table(deseq_res_P2[[2]], keep.rownames=TRUE)[, list(rn, deseq_P2_adjp=padj,enrichment2des=enrichment)],
                         by='rn', all=TRUE)
significant_tax <- merge(significant_tax,
                         data.table(deseq_res_P3[[2]], keep.rownames=TRUE)[, list(rn, deseq_P3_adjp=padj,enrichment3des=enrichment)],
                         by='rn', all=TRUE)
significant_tax <- merge(significant_tax,
                         data.table(deseq_res_time[[2]], keep.rownames=TRUE)[, list(rn, deseq_timeseries_adjp=padj,enrichment_alldes=enrichment),],
                         by='rn', all=TRUE)
significant_tax <- merge(significant_tax,
                         data.table(zig_res_P1[[2]], keep.rownames=TRUE)[, list(rn, mtgseq_P1_adjp=adjPvalues,enrichment1mtg=enriched)],
                         by='rn', all=TRUE)
significant_tax <- merge(significant_tax,
                         data.table(zig_res_P2[[2]], keep.rownames=TRUE)[, list(rn, mtgseq_P2_adjp=adjPvalues,enrichment2mtg=enriched)],
                         by='rn', all=TRUE)
significant_tax <- merge(significant_tax,
                         data.table(zig_res_P3[[2]], keep.rownames=TRUE)[, list(rn, mtgseq_P3_adjp=adjPvalues,enrichment3mtg=enriched)],
                         by='rn', all=TRUE)
significant_tax <- merge(significant_tax,
                         data.table(zig_res_time[[2]], keep.rownames=TRUE)[, list(rn, mtgseq_timeseries_adjp=adjPvalues,enrichmentallmtg=enriched)],
                         by='rn', all=TRUE)
...
write.csv(fullsigtab_esv, file = "EnrichmentASV_Table_8_26_2020.csv")
