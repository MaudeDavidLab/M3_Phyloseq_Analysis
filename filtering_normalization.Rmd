...
saveRDS(ps_tss, "Normalized/ps_tss_pass_min_postDD_min0.03.rds")
```
...
dir.create(path = "Filtered")
saveRDS(ps_deseq_filt, "Filtered/ps_deseq_friedfilt.rds")
saveRDS(ps_css_filt, "Filtered/ps_css_friedfilt.rds")
saveRDS(ps_no_norm_filt, "Filtered/ps_no_norm_friedfilt.rds")
```